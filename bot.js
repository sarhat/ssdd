  ...
  fs.readFile(`./${kahAVA}.txt`, function(err, data) {
    ...
    if (message.content.startsWith(prefix + "randomava")) {
      client.user.setAvatar(
        "https://cdn.discordapp.com/attachments/673708262218268682/743880577291124806/20200814_193756.png"
      );
...
client3.on("message", message => {
  fs.readFile(`./${kahAVA}.txt`, function(err, data) {
    ...
    if (!dinfo.owner.includes(message.author.id)) return;
    if (message.content.startsWith(prefix + "randomava")) {
      client3.user.setAvatar(
        "https://cdn.discordapp.com/attachments/673708262218268682/737909738557407272/20200729_082313.png"
      );
      message.channel.send(`**»وێـنـەی  ئـەڪـاونـتـەڪـان گــۆڕا**`);
    }
  });
